...
function templateTasks(task, i) {
    return ` 
        <div class="board-task" id="${task['place']}${i}" draggable="true" ondragstart="startDragging(${task['id']})" ondragend="removeHover()">
            ...
            <div class="board-footer">
                ...
                <div class="cursor"><img onclick="deleteTask(${task['id']})" src="img/basket.png"</div>
            </div>
        </div>
    `;
}
